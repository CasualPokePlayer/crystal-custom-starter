...
SPRITEMOVEDATA_DOUGLAS EQU SPRITEMOVEDATA_STANDING_UP * DEF(RNGHAX) + SPRITEMOVEDATA_SPINRANDOM_FAST * !DEF(RNGHAX)
	...
	object_event  2,  4, SPRITE_ROCKER, SPRITEMOVEDATA_DOUGLAS, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 1, TrainerBoarderDouglas, -1
